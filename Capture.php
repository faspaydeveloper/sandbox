<html>
<head>
<TITLE>Faspay - Capture API Test</TITLE>
...
<body >
<p align="left"><b>This is the payment test page for integrating to Faspay Capture API:</b></p>
<form ACTION="" method="POST" name="theForm" content-type="application/x-www-form-urlencoded">
    <table border="1" cellspacing="1" cellpadding="2" style="width: 100%">
      ...
      <tr> 
        ...
        <td>
          <input name="TRANSACTIONTYPE" size="2" value="2" required>
        </td>
      </tr>
      <!-- PAYMENT_METHOD -->
      <tr>
      ...
      <tr> 
        ...
        <td> <input name="TXN_PASSWORD" size="50" value="wyouw"> </td>
      </tr>      
       <!-- SIGNATURE -->
      <tr> 
