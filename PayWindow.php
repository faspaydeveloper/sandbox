<html>
<head>
<TITLE>Faspay - Payment Window API Test</TITLE>
...
<script language="JavaScript">
    ...
    function generateReturnPage(form){
                form.MREF7.value = 'https://ppsdev.infinitium.com';
            }
</script>
</head>

<body >
<p align="left"><b>This is the payment test page for integrating to Faspay Payment Window:</b></p>
...
<form ACTION="" method="POST" name="theForm" content-type="application/x-www-form-urlencoded">
  <div align="center"><center>
    <table border="1" cellspacing="1" cellpadding="2">
      ...
      <tr>
          <td>Action URL</td>
          <td colspan="2"><input name="actionurl" size="100%" value="https://ucdev.faspay.co.id:443/payment/PaymentWindow.jsp" disabled></td>
      </tr>
      <tr bgcolor="#FFFF99"> 
     ...
     <!-- DESCRIPTION -->
      ...
      <tr> 
        ...
        <td>RETURN_URL</td>
        <td> <input name="RETURN_URL" size="55" value="https://ucdev.faspay.co.id:443/API2/PaymentWindowReturn.jsp"> </td>
      </tr>
       <!-- handshake_url -->
      <tr>
        <td>Handshake URL</td>
...
<?php
    if(isset($_POST['submit'])){
        ...
        $signaturecc=strtoupper(sha1($hes));
