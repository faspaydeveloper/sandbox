...
<body>
    <div class="container">
        ...
        <form action="" method="post" id="theForm" name="theForm">
            ...
            <p>Merchant TranID <input type="text" name="merchant_tranid" class="form-control" value="20161223_090100" required></p>
            <p>Transaction ID <input type="text" name="transaction_id" class="form-control" value="39515" required></p>
